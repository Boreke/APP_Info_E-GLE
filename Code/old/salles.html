...
<body>
    ...
    <header>
        ...
        <nav id="nav">
            ...
            <li><a href="salles.html"  class="nav_elmt1">Salles</a></li>
        </nav>
    ...
    <section class="center">
        ...
        <div class="cinema-list">
            <div class="cinema-elmt">
                ...
                <div class="cinema-elmt-top">
                    <div class="cinema-info">
                        <img class="objet-fit" src="img/logo-ugc.png" alt="Logo UGC">
                    ...
                    <img class="dropdown" src="img/Drop Down.png" alt="">
                </div>
            ...
            <div class="cinema-elmt">
                ...
                <div class="cinema-elmt-top">
                    <div class="cinema-info">
                        <img class="objet-fit" src="img/logo-mk2.png" alt="Logo mk2">
                        <div class="cinema-desc">
                            <h3>mk2 Parnasse</h3>
                            <p>7 place De La Rotonde, 75001 Paris</p>
                            <p>10 salles</p>
            ...
            <div class="cinema-elmt">
                ...
                <div class="cinema-elmt-top">
                    <div class="cinema-info">
                        <img class="objet-fit" src="img/logo-pathe.png" alt="Logo Pathé">
                        <div class="cinema-desc">
                            <h3>UGC Ciné Cité Les Halles</h3>
                            <p>7 place De La Rotonde, 75001 Paris</p>
                            <p>10 salles</p>
